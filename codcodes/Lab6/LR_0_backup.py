...
def get_data_LR_0_states(input_file) :
  global  graph, set_terminal, set_non_terminal, first_table, root, follow_table, mini_item_set, serial_productions

  executer(input_file)

  return  graph, set_terminal, set_non_terminal, first_table, root, follow_table, mini_item_set, serial_productions
